...
![image](conflict_2.png)

Итак, конфликт состоялся. Как видите у меня был выбор из 4 вариантов:
1. Сохранить только те изменения которые были в ветке "master"
2. Принять изменения из ветки "conflict"
3. Принять обе версии файла, в таком случае у меня остался бы текст из обеих веток.
4. Сравнить изменения.

Как вы можете выбрать я выбрал пункт 2.

# Спасибо за внимание

P.S.

А вот так делаются таблицы:
